            ...
            <div class="col-lg-6 col-12 mt-sm-4">
              <div class="row mt-md-3 mt-sm-3">
                ...
                <div class="col-6">
                  ...
                  <ul>
                    <li>
                      <a href="<?php base_url() ?>/Umum">Beranda</a>
                    </li>
                    <li>
                      <a href="<?php base_url() ?>/Umum/koleksi">Koleksi</a>
                    </li>
                    <li>
                      <a href="<?php base_url() ?>/Umum/laporkan" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Laporkan</a>
                    </li>
                    <li>
                      <a href="<?php base_url() ?>/Umum/index#tentang" class="tentang-about">Tentang</a>
                    </li>
                  </ul>
                </div>
              </div>
