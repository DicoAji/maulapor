...
<?= $this->section('content'); ?>
  ...
  <div class="container bg-light p-4 br25 ">
    <h2 class="kuning mt25">Laporan Masyarakat</h2>
    <div class="row">
          ...
          <?php  foreach ($laporan as $data) : ?>
            <tr class="data">
              ...
              <td> <?php if($data['status'] == 'selesai' ) :    ?>
                <div class="tengah">
                  <a href="<?php base_url() ?>/Admin/tambahDariLaporan/<?= $data['id_laporan']; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah Koleksi" class="btn btn-transparant">+</a></td>
                </div> 
                <?php endif ?>
              </tr>
          <?php endforeach; ?>
